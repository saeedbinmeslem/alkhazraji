...
const sections = [
  {
    ...
    content: `عند تسجيلكم أو إجراء طلب في متجر الخزرجي، نقوم بجمع المعلومات التالية: الاسم الكريم، رقم الهاتف للتواصل وتأكيد الطلبات، والعنوان لأغراض التوصيل. قد نجمع أيضاً بيانات الاستخدام الأساسية لتحسين تجربة التسوق لديكم، وذلك بصورة مجهولة الهوية.`,
  },
  {
  ...
  {
    title: 'التواصل معنا',
    content: `إن كان لديكم أي استفسار أو قلق يتعلق بسياسة الخصوصية أو طريقة تعاملنا مع بياناتكم، لا تترددوا في التواصل معنا عبر البريد الإلكتروني: Alkhazraji8@gmail.com أو عبر واتساب على الرقم: 772503986. فريقنا سيسعد بالإجابة على جميع استفساراتكم.`,
  },
];
    ...
    >
      ...
      <div style={{ maxWidth: '800px', margin: '0 auto' }}>
        ...
        >
          ...
          >
            نحن في متجر الخزرجي نحترم خصوصيتكم ونلتزم بحماية بياناتكم الشخصية. توضح هذه السياسة كيفية جمع معلوماتكم واستخدامها والحفاظ عليها.
          </p>
        </motion.div>
        ...
        >
          متجر الخزرجي — خصوصيتكم أمانة لدينا
        </motion.p>
      </div>
    </div>
  );
